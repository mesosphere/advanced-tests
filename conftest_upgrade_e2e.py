...
@pytest.fixture(scope='session')
def oss_1_14_installer() -> Path:
    """
    Return the path to an installer for DC/OS OSS 1.14.
    """
    return Path('/tmp/dcos_generate_config_1_14.sh')
...
@pytest.fixture(scope='session')
def enterprise_1_14_installer() -> Path:
    """
    Return the path to an installer for DC/OS Enterprise 1.14.
    """
    return Path('/tmp/dcos_generate_config_1_14.ee.sh')
